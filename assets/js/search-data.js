...
ninja.data = [{
    ...
    handler: () => {
      ...
      handler: () => {
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6E%61%6E%6F%6F%6D.%6C%65%65@%6A%68%75.%65%64%75", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/nanoomlee", "_blank");
        },
      },{
        id: 'social-inspire',
        title: 'Inspire HEP',
        section: 'Socials',
        handler: () => {
          window.open("https://inspirehep.net/authors/1810316", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/nanoomlee", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=K85Z3MEAAAAJ", "_blank");
        },
      },{
      id: 'light-theme',
